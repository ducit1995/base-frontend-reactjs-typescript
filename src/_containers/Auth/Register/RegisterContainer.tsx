...
function RegisterContainer() {
    ...
    return (
        <div className="container  mt-3">
            <h2>Register</h2>
            {alert.message && alert.screen.includes(userConstants.SCREEN_REGISTER) && <Alert alert={alert} />}
            ...
            <div className="col-xs-12 text-center mt-3">
                <button type="submit" className={'btn mt-3 ' + (!validateParam() ? 'btn-secondary' : 'btn-primary')} onClick={() => { handleSubmit() }}>Register</button>
            </div>
            <div className="col-xs-12 text-center mt-3">
                <Link to={'/'}>Login</Link>
            </div>
